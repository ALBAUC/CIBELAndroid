...
public class RVAppsPerfilAdapter extends RecyclerView.Adapter<RVAppsPerfilAdapter.AppViewHolder> {

    private Context context;
    private final List<Aplicacion> apps;
    private final List<Aplicacion> perfilApps;
    private final LayoutInflater inflater;

    public RVAppsPerfilAdapter(Context context, List<Aplicacion> apps) {
        this.apps = apps;
    ...
    public RVAppsPerfilAdapter(Context context, List<Aplicacion> apps, List<Aplicacion> perfilApps) {
        this.apps = apps;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    ...
    public void updateAppList(List<Aplicacion> updatedApps) {
        apps.clear();
    ...
    public class AppViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .add(R.id.container, AppDetailView.newInstance(aplicacion))
