...
import es.unican.appriegospersonales.activities.apps.detail.tabs.TabCvesView;
import es.unican.appriegospersonales.activities.apps.detail.tabs.TabSostenibilidadView;
...
public class VPAssetDetailAdapter extends FragmentStateAdapter {
    ...
    public int getItemCount() {
        return VPPerfilAdapter.Tab.values().length;
    }
}
