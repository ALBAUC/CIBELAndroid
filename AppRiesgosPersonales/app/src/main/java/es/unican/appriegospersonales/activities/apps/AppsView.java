...
public class AppsView extends Fragment implements IAppsContract.View, MainView.RefreshableFragment {

    private IAppsContract.Presenter presenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new AppsPresenter(this);
        presenter.init();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        categorias_rv.setAdapter(new RVCategoriaAdapter(getContext(),
                presenter.getCategorias(), presenter.getPerfilApps()));
    ...
    private void showAppDetailViewSuggestion(Uri data) {
        if (data != null) {
            ...
            if (intentData.startsWith("app://")) {
                ...
                Aplicacion aplicacion = presenter.getAppByName(appName);
                if (aplicacion != null) {
    ...
    public void refreshData() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, new AppsView())
                .commit();
    }
